...
class ThirdFragment : Fragment() {
    ...
    private var japaneseChapter1List = listOf(
        JapaneseMainItem("처음뵙겠습니다.", "하지메마시떼", "はじめまして。"),
        JapaneseMainItem("한국 서울에서 왔어요.", "칸코쿠노 소우루카라 키마시타", "韓国のソウルから来ました。"),
        JapaneseMainItem("제 이름은 OO입니다.", "와타시노 나마에와 00데쓰", "私の名前は○○です。"),
        JapaneseMainItem("감사합니다. 정말 기쁩니다.", "아리가토오고자이마스. 혼토니 우레시이데스", "ありがとうございます。本当に嬉しいです。"),
        JapaneseMainItem("정말 큰 도움이 됐어요.", "혼토니 다스카리마시타", "本当に助かりました。"),
        JapaneseMainItem("몇살이세요?", "오이쿠츠데스까", "おいくつですか？"),
        JapaneseMainItem("저는 한국인입니다.", "와타시와 칸코쿠진데스", "私は韓国人です。"),
        JapaneseMainItem("저는 스무살입니다.", "와타시와 하타치데스", "私は２０歳です。"),
        JapaneseMainItem("일본어는 조금밖에 못합니다.", "니혼고와 스코시 시카 데키마세", "日本語は少ししかできません。"),
        JapaneseMainItem("당신의 이름은 무엇입니까?", "아나따노 나마에와 난데스까", "あなたの名前はなんですか。"),
        JapaneseMainItem("저는 대학생입니다.", "와타시와 다이가쿠세에데스", "私は大学生です。"),
        JapaneseMainItem("앞으로 잘 부탁드립니다.", "코레까라 요로시꾸 오네가이시마쓰", "これからよろしくお願いします。"),
        JapaneseMainItem("진짜 멋져요.", "톳데모스바라시이", "とってもすばらしい。"),
        JapaneseMainItem("대단합니다.", "스고이데스", "すごいです。"),
        JapaneseMainItem("저는 회사원입니다.", "와타시와 카이샤잉데스", "私は会社員です。"),
        JapaneseMainItem("일본의 애니메이션과 만화를 좋아합니다.", "니혼노 아니메토 만가가 스키데스", "日本のアニメと漫画が好きです。"),
        JapaneseMainItem("일본어를 잘하게 되면 일본에서 일하고 싶습니다.", "니혼고가 조즈니 낫타라 니혼데 하타라키타이데스", "日本語が上手になったら日本で働きたいです。"),
        JapaneseMainItem("저의 취미는 영화감상과 음악 감상입니다.", "와타시노 슈미와 에에가토 온가쿠칸쇼오데스", "私の趣味は映画と音楽鑑賞です。"),
        JapaneseMainItem("전 일본어에 관심이 많습니다.", "와타시와 니혼고니 쿄오미가 아리마스", "私は日本語に興味があります。"),
